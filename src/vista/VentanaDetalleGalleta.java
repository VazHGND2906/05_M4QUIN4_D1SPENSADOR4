 ...
 * @date 07/07/2016 - 00:16:03
 * @project 05_MaquinaDispensadora
 * @file VentanaDetalleGalleta.java
 */
public class VentanaDetalleGalleta extends JFrame {
	 ...
	 */
	public VentanaDetalleGalleta() {

		this.setTitle("ISLA GALLETOSA");
	...
	private void cargarControles() {
		...
		lblProducto1.setText("<html><body>GALLETA<br>Malvavisco cubierto de chocolate</body></html>");
