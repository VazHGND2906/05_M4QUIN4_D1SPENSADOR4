 ...
 * @date 07/07/2016 - 00:15:54
 * @project 05_MaquinaDispensadora
 * @file VentanaDetalleChocolate.java
 */
public class VentanaDetalleChocolate extends JFrame {
	 ...
	 */
	public VentanaDetalleChocolate() {

		this.setTitle("ISLA CHOCOLATOSA");
	...
	private void cargarControles() {
		...
		imgProducto1 = new ImageIcon(VentanaDetalleDulce.class.getResource("/img/chocolate_1.jpg"));
		imgProducto2 = new ImageIcon(VentanaDetalleDulce.class.getResource("/img/chocolate_2.jpg"));
		imgProducto3 = new ImageIcon(VentanaDetalleDulce.class.getResource("/img/chocolate_3.jpg"));
		imgProducto4 = new ImageIcon(VentanaDetalleDulce.class.getResource("/img/chocolate_4.jpg"));
		imgProducto5 = new ImageIcon(VentanaDetalleDulce.class.getResource("/img/chocolate_5.jpg"));
		imgProducto6 = new ImageIcon(VentanaDetalleDulce.class.getResource("/img/chocolate_6.jpg"));
		imgProducto7 = new ImageIcon(VentanaDetalleDulce.class.getResource("/img/chocolate_7.jpg"));
		imgProducto8 = new ImageIcon(VentanaDetalleDulce.class.getResource("/img/chocolate_8.jpg"));
		imgProducto9 = new ImageIcon(VentanaDetalleDulce.class.getResource("/img/chocolate_9.jpg"));
		imgProducto10 = new ImageIcon(VentanaDetalleDulce.class.getResource("/img/chocolate_10.jpg"));

		lblProducto1.setText("<html><body>MALVAVISCO<br>Malvavisco cubierto de chocolate</body></html>");
		...
		lblProducto2.setText("<html><body>WAFERTIN<br>Crujiente galleta cubierta de chocolate</body></html>");
		...
		lblProducto3.setText("<html><body>PALILLIN<br>Galleta rellena y cubierta de chocolate</body></html>");
		...
		lblProducto4.setText("<html><body>CHOCOLATE SUIZO<br>Chocolate masizo de chocolate</body></html>");
		...
		lblProducto5.setText("<html><body>RANITA<br>Chocolate con avena inflada en forma de rana</body></html>");
		...
		lblProducto6.setText("<html><body>CHOCO TINES<br>Hojuelas de chocolate</body></html>");
		...
		lblProducto7.setText("<html><body>CONFICHOKY<br>Cacahuate confitado</body></html>");
		...
		lblProducto8.setText("<html><body>SURTIDO<br>Las mejores barritas de chocolate</body></html>");
		...
		lblProducto9.setText("<html><body>CHOCORIS<br>Barritas de cereal con chocolate</body></html>");
		...
		lblProducto10.setText("<html><body>DE LA ROSA<br>Chocolate oscuro premium</body></html>");
