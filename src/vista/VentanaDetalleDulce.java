 ...
 * @date 07/07/2016 - 00:15:58
 * @project 05_MaquinaDispensadora
 * @file VentanaDetalleDulce.java
 */
public class VentanaDetalleDulce extends JFrame {
	 ...
	 */
	public VentanaDetalleDulce() {

		this.setTitle("ISLA DULSONA");
	...
	private void cargarControles() {
		...
		lblProducto1.setText("<html><body>TARRITO<br>Deliciosa paleta sabor cerveza</body></html>");
		...
		lblProducto2.setText("<html><body>PIÑITAS<br>Dulces en forma de piñas</body></html>");
		...
		lblProducto3.setText("<html><body>SKITTLES<br>Dulces variados multisabor</body></html>");
		...
		lblProducto4.setText("<html><body>ALIEN<br>Delicioso liquido agridulce</body></html>");
		...
		lblProducto5.setText("<html><body>MALVAVISCO<br>Malvavisco redondo</body></html>");
		...
		lblProducto6.setText("<html><body>TRENZA GIGANTE<br>Divertidos malvavisco en forma de trenza</body></html>");
		...
		lblProducto7.setText("<html><body>BICHOS<br>Divertidos dulces en forma de bichos</body></html>");
		...
		lblProducto8.setText("<html><body>EL CHAVO<br>Divertidos personajes del CHAVO DEL 8</body></html>");
		...
		lblProducto9.setText("<html><body>BOB ESPONJA<br>Delicioso dulce en forma de BOB ESPONJA</body></html>");
		...
		lblProducto10.setText("<html><body>CUPIDO<br>Enamora a un amigo con este delicioso dulce</body></html>");
